...
public class MostrarProductosAleatoriosAlterandoLaFKFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MostrarProductosAleatoriosAlterandoLaFKFrame frame = new MostrarProductosAleatoriosAlterandoLaFKFrame();
	 ...
	 * Create the frame.
	 */
	public MostrarProductosAleatoriosAlterandoLaFKFrame() {
		...
		this.setTitle("Mostrar Productos Aleatorios Alterando la FK");
		setClosable(true);
		...
		JLabel lblNewLabel = new JLabel("<html>\r\nPermite obtener una cantidad determinada de registros y de forma aleatoria, pero cambiando la clave foranea (Mostrar otra columna de la tabla agena, esto se realiza gracias a las clases del paquete FK\r\n</html>");
