...
public class BuscarProductosFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuscarProductosFrame frame = new BuscarProductosFrame();
	...
	public BuscarProductosFrame() {
		...
		JLabel lblNewLabel = new JLabel("Permite buscar uno o varios registros en base a una condici\u00F3n");
